...
man_fail=0
for item in bcm install.sh install_answers.conf.example scripts/preflight_check.sh scripts/portal_export.sh README.md LICENSE NOTICE DEPLOY_REQUIREMENTS.txt; do
