...
* **БД** — на всех `web` правило ProxySQL `^SELECT` (rule_id=4) временно направляется
...
Active-active сохраняется — без sticky-сессий и без двусторонней синхронизации кэша:
