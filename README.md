...
⚠️ Требуют слоя S3: без него install.sh не создаёт ни бакета, ни таймеров, а меню 13
сообщает, что копирование не настроено — организуйте копии внешними средствами.
