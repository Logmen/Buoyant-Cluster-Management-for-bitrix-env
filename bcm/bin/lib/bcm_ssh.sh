...
bcm_deploy_to_node() {
    ...
    for f in bin/bcm bin/lib/bcm_utils.sh bin/lib/bcm_config.sh \
              ...
              bin/lib/ssl_certs.sh bin/lib/bcm_backup.sh bin/lib/bcm_backup_setup.sh \
              bin/lib/bcm_s3_external.sh \
              ...
              bin/lib/bcm_dbrouter.sh bin/lib/bcm_messenger.sh bin/lib/bcm_pxc_harden.sh \
              bin/lib/bcm_modules.sh VERSION; do
